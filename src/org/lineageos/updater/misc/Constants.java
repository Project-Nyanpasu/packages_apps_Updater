...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.nyanpasu.version.codename";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.nyanpasu.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.nyanpasu.build.variant";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "nyanpasu.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "nyanpasu.updater.uri";
